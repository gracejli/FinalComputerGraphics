...
class Renderer{
    ...
    */
    setVertexAttributeArrays(model){
        ...
        //TODO DONE: Link up texcoord-buffer (model.mesh.texcoordBuffer) and
        ...
        //double check, is this 3? maybe it's 2 because it's 2D
    ...
    */
    setUniformData(model, camera, shaderData){
        ...
        //just added this
        let cameraPosition = gl.getUniformLocation(this.program, "u_cameraPosition");
        gl.uniform3fv(cameraPosition, camera.getPosition().toFloat32());

        let shinyPosition = gl.getUniformLocation(this.program, "u_shininess");
        gl.uniform1f(shinyPosition, model.material.shininess);

        let specularityPosition = gl.getUniformLocation(this.program, "u_specularity");
        gl.uniform1f(specularityPosition, model.material.specularIntensity);
